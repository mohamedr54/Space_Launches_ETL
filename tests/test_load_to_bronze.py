...
def test_fetch_launches_data():
    ...
    mock_r.json.return_value = {"id": 13, "status": "successful",
                                "center": "Kennedy Space Center"}  # giving the object data

    with mock.patch('requests.get',
                    return_value=mock_r):  # replacing the requests.get by the fake mock object in the function
        fetch_launches_data()
